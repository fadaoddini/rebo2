...
from shop.models import Product, Location, MyShop, ProductImage, Package, Category, Basket
...
class CheckUserShopApiV1(APIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class PackageListApiV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
    def get(self, request, *args, **kwargs):
        packages = Package.objects.all()
...
class CategoryListApiV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
    def get(self, request, *args, **kwargs):
        categories = Category.objects.filter(parent__isnull=True)  # فقط والدین
...
class ChildCategoryListApiV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
    def get(self, request, parent_id, *args, **kwargs):
        categories = Category.objects.filter(parent_id=parent_id)  # فقط فرزندان
...
class EditProductApiV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class InactiveProductsListViewV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class ActiveProductsListViewV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class FeaturedProductsListViewV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
...
class AllProductsShopsApiV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
    def get(self, request, *args, **kwargs):
        context = dict()
...
class ProductByIdApiV1(APIView):
    authentication_classes = [CookieJWTAuthentication]
    permission_classes = [IsAuthenticated]
    def get(self, request, id, *args, **kwargs):
        context = dict()
        product = Product.objects.filter(Q(pk=id) | Q(upc=id)) \
            .filter(is_active=True).get()
        serializer = ProductShopSerializer(product)
        return Response(serializer.data, content_type='application/json; charset=UTF-8')
...
class CartAPIView(APIView):
    ...
    def post(self, request):
        ...
        return Response({"message": "Product added to basket successfully."}, status=status.HTTP_201_CREATED)
    ...
    def delete(self, request, item_id):
        ...
        return Response({"message": "Product removed from basket."}, status=status.HTTP_204_NO_CONTENT)